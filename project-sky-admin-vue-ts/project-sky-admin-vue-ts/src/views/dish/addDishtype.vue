<template>
  <div :key="vueRest" class="addBrand-container dish-add-page">
...
.addBrand-container {
  ...
  .container {
    ...
    .subBox {
      ...
      .el-button--primary:hover { transform: translateY(-2px); box-shadow:0 10px 22px rgba(79,172,254,0.18); }
      .continue-add { padding:8px 16px; border-radius:6px; }
    }
  }
}

/* 将添加口味按钮改为套餐/菜品页主按钮同样的蓝色渐变样式 */
.flavorBox {
  width: 777px;
