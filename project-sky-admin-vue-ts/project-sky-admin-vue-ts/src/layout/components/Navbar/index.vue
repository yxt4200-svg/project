...
.navbar {
  ...
  .el-dialog__body {
    ...
    .el-radio-group {
      & > .is-checked {
        border: 1px solid #4FACFE;  // 修改：选中边框改为蓝色
      }
    }
    .el-radio {
      width: 100%;
...
.userInfo {
  ...
  p {
    ...
    &:hover {
      background: #e3f2fd;  // 修改：悬停背景改为淡蓝色
    }
  }
}
.msgTip {
  color: #4FACFE;  // 修改：提示文字改为蓝色
  padding: 0 5px;
}
</style>
